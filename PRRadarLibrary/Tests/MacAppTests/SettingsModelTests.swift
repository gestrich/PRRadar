...
struct SettingsModelTests {
    ...
    func addConfiguration() throws {
        let model = makeModel()
        let config = RepositoryConfigurationJSON(name: "test", repoPath: "/tmp/repo", githubAccount: "test", defaultBaseBranch: "main")
    ...
    func updateConfiguration() throws {
        let model = makeModel()
        let configId = UUID()
        let config = RepositoryConfigurationJSON(id: configId, name: "original", repoPath: "/tmp/repo", githubAccount: "test", defaultBaseBranch: "main")
        try model.addConfiguration(config)
    ...
    func removeConfiguration() throws {
        let model = makeModel()
        let config = RepositoryConfigurationJSON(name: "doomed", repoPath: "/tmp/repo", githubAccount: "test", defaultBaseBranch: "main")
        try model.addConfiguration(config)
    ...
    func setDefault() throws {
        let model = makeModel()
        let first = RepositoryConfigurationJSON(name: "first", repoPath: "/tmp/repo1", githubAccount: "test", defaultBaseBranch: "main")
        let second = RepositoryConfigurationJSON(name: "second", repoPath: "/tmp/repo2", githubAccount: "test", defaultBaseBranch: "main")
    ...
    func updateNonexistentAdds() throws {
        let model = makeModel()
        let config = RepositoryConfigurationJSON(name: "ghost", repoPath: "/tmp/repo", githubAccount: "test", defaultBaseBranch: "main")
    ...
    func addDoesNotThrow() throws {
        let model = makeModel()
        let config = RepositoryConfigurationJSON(name: "valid", repoPath: "/tmp/repo", githubAccount: "test", defaultBaseBranch: "main")
    ...
    func observeChangesYields() async throws {
        ...
        let config = RepositoryConfigurationJSON(name: "observed", repoPath: "/tmp/repo", githubAccount: "test", defaultBaseBranch: "main")
