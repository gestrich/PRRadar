...
from prradar.domain.diff import DiffLine, DiffLineType, GitDiff, Hunk
from prradar.infrastructure.git.diff_parser import (
    format_diff_as_json,
    format_diff_as_text,
    has_content,
...
class TestFilePathFiltering(unittest.TestCase):
    ...
    def test_objc_patterns_match_header(self):
        ...
        from prradar.domain.rule import AppliesTo
...
class TestRuleGrepPatterns(unittest.TestCase):
    ...
    def test_grep_any_single_pattern_match(self):
        ...
        from prradar.domain.rule import GrepPatterns
