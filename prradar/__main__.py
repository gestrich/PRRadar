...
from prradar.commands.agent import cmd_agent, setup_agent_parser
...
Examples:
  prradar post-review --execution-file output.json --pr-number 123 --repo owner/repo
  prradar handle-mention --execution-file output.json --pr-number 123 --repo owner/repo
  prradar parse-diff --input-file diff.txt --format text
